...
import 'package:donobox/pages/crowdfund_form.dart';
                  ...
                  if (snapshot.data!.length == 0) {
                    if (loggedRole == 'Fundraiser') {
                      return Container(
                        ...
                        alignment: Alignment.center,
                        child: const Text(
                          'Anda belum mengajukan galangan dana.',
                          textAlign: TextAlign.center,
                        ),
                      );
                    }
                    return Container(
                      ...
                      alignment: Alignment.center,
                      child: const Text(
                        'Belum ada galangan dana yang sedang berlangsung saat ini.',
                        textAlign: TextAlign.center,
                      ),
                    );
                  }
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => CrowdfundFormPage(
                    loggedUsername: loggedUsername,
                    loggedRole: loggedRole,
                  ),
                ),
